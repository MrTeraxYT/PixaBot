...
const loghook =  new Discord.WebhookClient("347289220638965762", "token")
...
loghook.edit("Command Log", client.user.displayAvatarURL)
    console.log("[STATUS] PixaBot - locked and loaded!");
console.log("\n",
"=======================================\n",
"               BOT LOGIN\n",
"=======================================\n",
  ...
  if (typeof(text) === "string")
   ...
   if (message.content.startsWith(prefix + "consoleval")) {
    ...
    try {
	  ...
	  .addField("Input ðŸ“¥", args.join(' '))
	  .addField("Output ðŸ“¤", "```x1\n" + clean(err) + "```")
	  msg.author.send({embed})
      console.log("========================================================================================\nEVAL RESULTS\nERROR\n\nINPUT:\n" + args.join(' ') + "\nOUTPUT:\n" + clean(err) + "\n========================================================================================\n");
    }
      }  //End of Eval
