...
client.on("message", function(message) {
    ...
    switch (args[0]) {
        ...
        case "help":
            ...
            .setDescription("Here are my available commands. To execute one of my commands, my prefix is `px;`or for music `px! to learn more about music commands type in px!help.\n\n**Parameters:**\n< > - Required\n[ ] - Optional".replace('px;', prefix))
